	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'thorns':
				...
				FlxG.sound.music.fadeIn(1, 0, 0.8);
			default:
				FlxG.sound.playMusic(Paths.music('sounds/Cutscene', 'shared'), 0);
				FlxG.sound.music.fadeIn(1, 0, 0.8);
		}
		...
		else
		{
			...
			portraitLeft.frames = Paths.getSparrowAtlas('portraits/avey_portrait', 'shared');
			portraitLeft.animation.addByPrefix('enter', 'normal', 24, false);
